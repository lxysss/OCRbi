...
public class BookManageAdapter extends RecyclerView.Adapter<BookManageAdapter.ViewHolder> {
    ...
    private View mView;
    public BookManageAdapter(List<getBook> BookList){
        mBookList=BookList;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View view) {
            super(view);
            mView=view;
            book_img=view.findViewById(R.id.book_manage_img);

            book_name=view.findViewById(R.id.book_manage_name);

            book_author=view.findViewById(R.id.book_manage_author);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View view= LayoutInflater.from(parent.getContext())
                .inflate(R.layout.book_manage_item,parent,false);
